...
#define SMOOTH_GROUP_HOUSE_WALLS S_TURF(59) ///turf/closed/wall/wood/house

#define MAX_S_TURF SMOOTH_GROUP_HOUSE_WALLS //Always match this value with the one above it.
...
#define SMOOTH_GROUP_CONCRETE_WALLS S_OBJ(72) ///turf/closed/wall/concrete, /obj/structure/falsewall/concrete

#define SMOOTH_GROUP_WOOD_TABLES_SHODDY S_OBJ(73) ///obj/structure/table/wood/shoddy
#define SMOOTH_GROUP_BOOTH_TABLES S_OBJ(74) ///obj/structure/table/booth

#define MAX_S_OBJ SMOOTH_GROUP_BOOTH_TABLES //Always match this value with the one above it.
