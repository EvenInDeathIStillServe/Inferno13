...
/obj/effect/turf_decal/roadmarking
	name = "road marking"
	...
	icon_state = "singlevertical" //See decoration.dmi for different icon states of road markings.
	layer = 2.1

/obj/effect/turf_decal/riverbank
	name = "riverbank"
	desc = "try"
	icon = 'icons/obj/decoration.dmi'
...
/obj/effect/turf_decal/riverbankcorner
