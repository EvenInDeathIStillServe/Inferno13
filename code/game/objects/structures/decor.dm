//Inferno 13 structural decorations directory
...
/obj/structure/decoration/rag //Generic decoration. See decoration.dmi - there are more things to choose the proper icon_state in map editor.
	name = "rag"
...
/obj/structure/decoration/sign //Signs.
	...
	icon_state = "vault_blank" //See decoration.dmi for different icon states for different signs.
...
/obj/structure/decoration/ruins //Ruin decorations - they overlap the player most of time, thus they provide a nearly perfect hiding spot.
	...
	icon_state = "overlap" //See decoration.dmi for different icon states of ruins overlays.
	layer = 4.2
...
/obj/structure/decoration/reflector
	name = "road reflector"
	desc = "An ancient road safety device."
...
/obj/structure/decoration/rads
	name = "radiation sign"
	desc = "A sign indicating for the user to be wary of something radioactive in the area."
