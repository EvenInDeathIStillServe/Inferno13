...
/obj/structure/chair/sofa/booth
	name = "booth"
	desc = "A diner-style booth seating."
	icon_state = "booth_single"

/obj/structure/chair/sofa/booth/left
	icon_state = "booth_end_left"

/obj/structure/chair/sofa/booth/middle
	icon_state = "booth_middle"

/obj/structure/chair/sofa/booth/right
	icon_state = "booth_end_right"