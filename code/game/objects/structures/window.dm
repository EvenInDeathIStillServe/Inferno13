...
/obj/structure/window/fulltile/inferno
...
/obj/structure/window/fulltile/inferno/ruins
	icon_state = "ruinswindow"
	dir = 5
	max_integrity = 20

/obj/structure/window/fulltile/inferno/ruins/broken
	icon_state = "ruinswindowbroken"
	max_integrity = 1

/obj/structure/window/fulltile/inferno/house
	icon_state = "housewindow"
	dir = 5
	max_integrity = 40

/obj/structure/window/fulltile/inferno/house/broken
	icon_state = "housewindowbroken"
	max_integrity = 1

/obj/structure/window/fulltile/inferno/wood
	icon_state = "woodwindow"
	dir = 5

/obj/structure/window/fulltile/inferno/wood/broken
	icon_state = "woodwindowbroken"
	max_integrity = 1

/obj/structure/window/fulltile/inferno/store
