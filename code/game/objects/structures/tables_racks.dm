...
/obj/structure/table/wood/shoddy
	desc = "A wooden table constructed by a carpentering amateur from various planks."
	icon = 'icons/obj/smooth_structures/shoddy_table.dmi'
	icon_state = "shoddy_table-0"
	base_icon_state = "shoddy_table"
	max_integrity = 50
	smoothing_groups = list(SMOOTH_GROUP_WOOD_TABLES_SHODDY) //Don't smooth with SMOOTH_GROUP_TABLES or SMOOTH_GROUP_WOOD_TABLES
	canSmoothWith = list(SMOOTH_GROUP_WOOD_TABLES_SHODDY)

/obj/structure/table/booth
	name = "booth table"
	desc = "A diner style booth table."
	icon = 'icons/obj/smooth_structures/booth_table.dmi'
	icon_state = "booth_table-0"
	base_icon_state = "booth_table"
	smoothing_groups = list(SMOOTH_GROUP_BOOTH_TABLES) //Don't smooth with SMOOTH_GROUP_TABLES or SMOOTH_GROUP_WOOD_TABLES
