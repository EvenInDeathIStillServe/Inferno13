...
/datum/map_config
	// Metadata
	var/config_filename = "_maps/inferno.json"
	...
	// Config actually from the JSON - should default to Inferno
	var/map_name = "Inferno"
	var/map_path = "map_files/Inferno"
	var/map_file = "Inferno.dmm"
