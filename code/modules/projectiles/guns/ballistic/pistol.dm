...
/obj/item/gun/ballistic/automatic/pistol/browning
	name = "\improper Browning Hi-power"
	desc = "A mass produced Browning Hi-power 9mm pistol."
	icon_state = "ninemil"
	...
	fire_delay = 2
	can_suppress = FALSE
	fire_sound = 'sound/weapons/gun/pistol/ninemil.ogg'
	rack_sound = 'sound/weapons/gun/pistol/rack.ogg'
	lock_back_sound = 'sound/weapons/gun/pistol/slide_lock.ogg'
	bolt_drop_sound = 'sound/weapons/gun/pistol/slide_drop.ogg'
	minimum_combat_skill = 3

/obj/item/gun/ballistic/automatic/pistol/ruger
	name = "Ruger MKII"
	desc = "A .22LR rimfire semi-automatic handgun with an integrated silencer."
	icon_state = "ruger"
	...
	suppressed = 1
	fire_sound = 'sound/weapons/gun/pistol/22pistol.ogg'
	rack_sound = 'sound/weapons/gun/pistol/rack.ogg'
	lock_back_sound = 'sound/weapons/gun/pistol/slide_lock.ogg'
	bolt_drop_sound = 'sound/weapons/gun/pistol/slide_drop.ogg'
	minimum_combat_skill = 1
