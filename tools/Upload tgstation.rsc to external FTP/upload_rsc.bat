...
@REM Replace FOLDER/FOLDER with the folder on the FTP server where you want to store inferno13.rsc, for example: cd www/rsc
@REM Replace FTP.DOMAIN.COM with the IP-address or domain name of your FTP server
@REM Add the URL to the location of inferno13.rsc on your webserver into data\external_rsc_urls.txt
@REM
@echo off
...
echo put ..\..\inferno13.rsc>> ftpcmd.dat
